...
def _get_system_encoding() -> str:
    r"""Get the appropriate encoding for subprocess output.
    
    On Windows, uses the system's preferred encoding (usually GBK for Chinese).
    On other systems, defaults to UTF-8.
    """
